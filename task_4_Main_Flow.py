...
df=pd.read_csv("C:\\Users\\bhmoh\\Downloads\\USvideos.csv")
print(df.head())
print(df.shape)
...
print(df.describe())
print(df.info())
cols=['thumbnail_link','description']
...
plt.figure(figsize=(12,6))
sns.barplot(x=videos_per_hour.index, y=videos_per_hour.values, hue=videos_per_hour.index,legend=False)
